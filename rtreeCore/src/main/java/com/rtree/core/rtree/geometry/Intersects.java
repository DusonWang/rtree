...
public final class Intersects {
    ...
    private static final Func2<Geometry, Point, Boolean> geometryIntersectsPoint = (Geometry geometry, Point point) -> geometryIntersectsRectangle.call(geometry, point.mbr());
